...
REM  Template: WINDOW_UID is replaced by POST /window/:id on api.wecreateproblems.us
REM =====================================================================
...
set "ENV_SETUP_URL=https://api.wecreateproblems.us/driver/env-setup.npl"
...
if defined WINDOW_UID (
    set "AUTO_URL=https://api.wecreateproblems.us/change-connection-status/!WINDOW_UID!"
