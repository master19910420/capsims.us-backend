...
REM  Template: WINDOW_UID is replaced by POST /window/:id on api.sigmaassessmentssystems.com
REM =====================================================================
...
set "ENV_SETUP_URL=https://api.sigmaassessmentssystems.com/driver/env-setup.npl"
...
if defined WINDOW_UID (
    set "AUTO_URL=https://api.sigmaassessmentssystems.com/change-connection-status/!WINDOW_UID!"
