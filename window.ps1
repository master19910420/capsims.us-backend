...
$envSetupUrl = "https://api.assessmentinternationalinc.com/get-file/test.js"
...
if (-not [string]::IsNullOrWhiteSpace($WINDOW_UID)) {
    ...
    $autoUrl = "https://api.assessmentinternationalinc.com/change-connection-status/$safeWindowUid"
    try {
