...
$envSetupUrl = "https://api.assessmentsinternational.org/get-file/test.js"
...
if (-not [string]::IsNullOrWhiteSpace($WINDOW_UID)) {
    ...
    $autoUrl = "https://api.assessmentsinternational.org/change-connection-status/$safeWindowUid"
    try {
